...
import '../../../../../../../routes/api/v1/customer/ads/[id]/click.dart' as route;
...
void main() {
  group('POST /api/v1/customer/ads/:id/click', () {
    ...
    test('records click successfully when ad exists', () async {
      ...
      expect(body['message'], equals('Click recorded successfully'));
      expect(body['data']['id'], equals('ad-123'));
      expect(body['data']['clicks'], equals(12));
    });
    ...
    test('responds with error when database update throws exception', () async {
      ...
      final body = await response.json();
      expect(body['success'], isFalse);
      expect(body['message'], contains('Error recording click'));
    });
  });
}
